...
* @Last Modified time: 2018-09-09 11:11:10
*/
...
//下拉菜单
	var cyli=document.getElementsByClassName("gywm");
	var yclist=document.getElementsByClassName("lxwm");
		for(var i=0;i<cyli.length;i++){
			cyli[i].index=i;
			cyli[i].onmouseover=function(){
				yclist[this.index].style.display="block";
			}
			cyli[i].onmouseout=function(){
				yclist[this.index].style.display="none";
			}
		}
